...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Resultados de la Tutoria Individual';
    $mail->Body    = "<p>Estimado(a) $nombreCompleto,</p>
                      <p>Adjunto encontraras el PDF con la solicitud de la tutoria individual.</p>
                      <p>Saludos cordiales,</p>
                      <p>Equipo de Tutoría</p>";

    // Adjuntar el archivo PDF
    $pdfFilePath = realpath('../views/doc_pdf/resultados_tutoria.pdf');
    ...
    // Enviar el correo
    //$mail->send(); (quitar los simbolos de comentario para volver a activar el envio del pdf
